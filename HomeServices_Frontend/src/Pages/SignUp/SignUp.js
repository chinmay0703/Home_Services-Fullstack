...
import signupImg from '../../images/avatarMale.png'
...
export default function Signup() {
    ...
    const SignUp = () => {
        if (password != ConfirmPassword) {
            ...
            const url = "http://localhost:3001/posts"; // Replace with your actual JSON server endpoint
        ...
        >
            ...
            <div style={{ backgroundColor: "whitesmoke" }}>
                ...
                <div className='container' style={{ backgroundColor: "white", minHeight: "500px" }}>
                    <br />
                    <center><h3 className='py-3'>Home-Services</h3></center> <hr />
                    <div className='row'>
                        <div className="col">
